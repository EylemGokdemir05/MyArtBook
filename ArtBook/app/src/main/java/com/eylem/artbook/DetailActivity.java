...
public class DetailActivity extends AppCompatActivity {
        ...
        if(info.matches("new")){
            ...
            try {
                ...
                while (cursor.moveToNext()){
                    ...
                    byte[] bytesArray=cursor.getBlob(imageIndex);
    ...
    public void save(View view){
        ...
        smallImage.compress(Bitmap.CompressFormat.PNG,50,outputStream); //görselin boyutu alınıyor ve küçültülüyor
        byte[] bytes=outputStream.toByteArray(); //byte'a(veriye) çevriliyor
